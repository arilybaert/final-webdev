            ...
            <form action="{{ route('admin.about.save') }}" method="POST">
                ...
                <div class="form-row">
                    <div class="form-group col-6">
                        <label for="title_left_nl" class="text-white">Title Left NL</label>
                      ...
                      <div class="form-group col-6">
                          <label for="title_left_en" class="text-white">Title Left NL</label>
                ...
                <div class="form-row">
                    <div class="form-group col-6">
                        <label for="content_left_nl" class="text-white">Content Left NL</label>
                      ...
                      <div class="form-group col-6">
                        <label for="content_left_en" class="text-white">Content Left NL</label>
